...
//		}
	...
	public static String getFileNameFromJar(String filename) throws URISyntaxException {
		String jarPath = Cbl2JsonCode.class.getProtectionDomain().getCodeSource().getLocation().toURI().getPath();
		return new File(jarPath).getParent() + File.separator + filename;
	}
}